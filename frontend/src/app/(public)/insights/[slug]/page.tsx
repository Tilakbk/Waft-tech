    ...
    <main>
      <section style={{ paddingTop: "10rem", paddingBottom: "3rem" }}>
        <div className="container-custom" style={{ maxWidth: "900px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: "0.85rem", fontWeight: 500, color: "var(--color-brand-teal)" }}>{post.category}</span>
          </div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4.5vw, 3.5rem)", fontWeight: 700, color: "var(--color-black)", lineHeight: 1.1 }}>
            {post.title}
          </h1>
        </div>
      </section>
      ...
      <section style={{ marginBottom: "4rem" }}>
        <div className="container-custom">
          <div style={{ width: "100%", height: "min(45vw, 440px)", borderRadius: "var(--radius-md)", overflow: "hidden", backgroundColor: "#1a1a6e" }}>
      ...
      <section className="container-custom" style={{ marginBottom: "7rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "56px 1fr", gap: "4rem", alignItems: "start" }}>
            ...
            {[
              ...
              { label: "Twitter", icon: "x", href: "https://twitter.com" },
                ...
                style={{
                  ...
                  fontSize: "0.75rem", fontWeight: 600, color: "var(--color-gray-mid)",
          ...
          <div style={{ maxWidth: "720px" }}>
            <p style={{ fontSize: "1.1rem", color: "var(--color-gray-mid)", lineHeight: 1.9, marginBottom: "2rem", fontWeight: 500 }}>{post.excerpt}</p>
            {paragraphs.map((para, i) => (
              <p key={i} style={{ fontSize: "1rem", color: "var(--color-gray-mid)", lineHeight: 1.9, marginBottom: "1.5rem" }}>{para}</p>
            ))}
            <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", paddingTop: "2.5rem", borderTop: "1px solid var(--color-gray-border)", marginTop: "3rem" }}>
              <div style={{ width: "52px", height: "52px", borderRadius: "50%", backgroundColor: "var(--color-brand-teal-light)", overflow: "hidden", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-display)", fontSize: "1.1rem", fontWeight: 700, color: "var(--color-brand-teal)" }}>
      ...
      {nextPost && (
        <section style={{ paddingBottom: "7rem" }}>
          <div className="container-custom" style={{ marginBottom: "2rem" }}>
            <h2 style={{ fontFamily: "var(--font-display)", fontSize: "1.75rem", fontWeight: 700, color: "var(--color-black)" }}>Next blog</h2>
          </div>
